            ...
            if not piloto_selecionado:
                ...
                kpi_query = """
                    ...
                    SELECT 
                        ...
                        SUM(CASE WHEN posicao_volta_rapida = 1 THEN 1 ELSE 0 END) AS voltas_rapidas,
